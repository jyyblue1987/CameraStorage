...
class Program_model extends MY_Model {    
    ...
    public $parking_rules = array(
        'car_id' => array('field'=>'car_id', 'label'=>'Car', 'rules'=>'trim|required'),
	...
	public $class_rules = array(
        'name' => array('field'=>'name', 'label'=>'Name', 'rules'=>'trim|required'),
      //  'athlete[]' => array('field'=>'athlete[]', 'label'=>'athlete', 'rules'=>'trim|required'),
        'coach[]' => array('field'=>'coach[]', 'label'=>'coach', 'rules'=>'trim|required'),
        'description' => array('field'=>'description', 'label'=>'description', 'rules'=>'trim|required'),
   );
...
/*            $this->rules_lang["title_$key"] = array('field'=>"title_$key", 'label'=>'lang:Title', 'rules'=>'trim|required|xss_clean');
	...
	public function get_new(){
        ...
        $products->description			= '';
        $products->gps 					= '-24.50, 134.14';

		//for classes
        $products->gym_id				= 0;
        $products->program_id			= 0;
		$products->s_time 				= date('H:i');
		$products->e_time 				= date('H:i');
		$products->dates 				= date('d-m-Y');
    ...
    public function delete($id)
    {
		...
		$this->db->delete('product_category', array('product_id'=>$id));
		$this->db->delete('products_award', array('product_id'=>$id));
		$this->db->delete('products_rating', array('product_id'=>$id));
		$this->db->delete('product_files', array('product_id'=>$id));
