...
/*        $templatesDirectory = opendir(APPPATH.'../templates/'.$CI->app_settings['template']);
    ...
    public function get_lang_banner($lang_id=1){
        ...
        $this->db->join($this->_table_name.'_lang', $this->_table_name.'.id = '.$this->_table_name.'_lang.event_id');
    ...
    function delete_lang($event_id){
	     $this->db->delete($this->_table_name.'_lang', array('event_id' => $event_id));
    ...
    public function save_with_lang($data, $data_lang, $id = NULL)
    {
        ...
        else
        {
            ...
            $this->db->delete($this->_table_name.'_lang', array('event_id' => $id));
    ...
    public function get_id_by_name ($event_id)
    {
        $this->db->select('*');
        $this->db->from($this->_table_name);
        $this->db->join($this->_table_name.'_lang', $this->_table_name.'.id = '.$this->_table_name.'_lang.event_id');
        ...
        foreach ($pages as $page) {
          if(url_title_cro($page['title'], '-', TRUE) == $event_id)  
          {
            return $page['id'];
          }
        }
    ...
    public function delete($id){
        $this->db->delete('events_lang', array('event_id' => $id)); 
