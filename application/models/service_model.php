   ...
   public $rules_lang = array();
    ...
    public function __construct(){
        ...
        foreach($this->languages as $key=>$value)
        {
            ...
            $this->rules_lang["body_$key"] = array('field'=>"body_$key", 'label'=>'lang:Body', 'rules'=>'trim|required|xss_clean');
        }
...
*/        
    ...
    function delete_lang($service_id){
		$this->db->delete($this->_table_name.'_lang', array('service_id' => $service_id));
    ...
    public function get_id_by_name ($service_id)
    {
        ...
        foreach ($pages as $page) {
          if(url_title_cro($page['title'], '-', TRUE) == $service_id)  
          {
            return $page['id'];
          }
        }
