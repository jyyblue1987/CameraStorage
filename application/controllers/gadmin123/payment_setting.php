...
class payment_setting extends Admin_Controller {
	public $_table_names = 'payment_setting';
	public $_subView = 'admin/payment_setting/';
	public $_redirect = '/payment_setting';
	...
	function index(){
		...
		$this->data['name'] = show_static_text($this->data['adminLangSession']['lang_id'],2540).'Hyperpay Setting';
		$this->data['title'] = $this->data['name'].' | '.$this->data['settings']['site_name'];
		$this->data['paypal']  = $this->comman_model->get_by($this->_table_names,array('id'=>1),false,false,true);
