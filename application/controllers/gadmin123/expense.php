...
class Expense extends Admin_Controller{
	public $_table_names = 'a_expense';

	public $_mainView = 'admin/_layout_main';
	public $_subView = 'admin/expenses/';

	public $_redirect = '/expense';
	...
	public function __construct(){
		...
		$this->checkPermissions('other_expense');
	}
    	
	function index(){
        $this->data['name'] = show_static_text($this->data['adminLangSession']['lang_id'],1700).'Expense';
    ...
    public function edit($id = NULL){
        ...
        if($this->form_validation->run() == TRUE){
			$post1 		= array('name','price','description');
...
/*			echo '<pre>';
            ...
            if(!empty($_FILES['logo'])){
                $config['upload_path']      = 'assets/uploads/expenses/';
                ...
                $post_data['image']  = $this->data['products']->image;
            }      
