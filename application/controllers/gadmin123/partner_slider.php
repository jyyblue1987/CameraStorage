...
class Partner_slider extends Admin_Controller{
	public $_table_names = 'partner_sliders';
	public $_subView = 'admin/partner_sliders/';
	public $_redirect = '/partner_slider';
	...
	{
		$this->data['name'] = show_static_text($this->data['adminLangSession']['lang_id'],184);
    ...
    public function edit($id = NULL)
	{
        ...
        if($this->form_validation->run() == TRUE){
			$data = $this->partner_slider_model->array_from_post(array('name','type','link'));
