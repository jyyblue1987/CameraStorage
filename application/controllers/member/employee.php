...
//		$this->_checkPaidUser();
	...
	function index(){
        ...
        $this->data['name'] = show_static_text($this->data['lang_id'],1000).'User';
        $this->data['title'] = $this->data['name'].' | '.$this->data['settings']['site_name'];
		$this->data['table'] = true;

		$this->data['all_data'] = $this->comman_model->get_by($this->_table_names,array('parent_id'=>$this->data['user_details']->id,'account_type'=>'E'),false,false,false);
...
/*			$this->load->library('image_lib');
			...
			$post_data['account_type'] 	= 'E';
			$post_data['type']			= 'Employee';
			$post_data['status'] 		= 1;
...
{site_name} Team</p>
    ...
    public function edit($id = NULL){
		...
		$this->data['users'] = $this->comman_model->get_by($this->_table_names,array('id'=>$id,'parent_id'=>$this->data['user_details']->id),false,false,true);
		if(!$this->data['users']){
			redirect($this->data['_cancel']);
		}
