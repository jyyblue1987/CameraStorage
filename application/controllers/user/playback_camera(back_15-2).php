...
//		$this->_checkPaidUser();
	...
	function index(){
		...
		$this->data['all_data'] = $this->comman_model->get_by($this->_table_names,array('user_id'=>$this->data['userClient']->id),false,array('order_playback'=>'asc'),false);
...
//		echo 'Yes';
		...
		$email_data = '<div style="border: solid #666;">
...
<div style="background-color: #999; color: #fff;padding-top:10px">
<h3 style="margin-left:20px">Your camera file..</h3>
</div>
...
{site_name} Team</p>
		...
		$email_data = str_replace('{site_name}', $this->data['settings']['site_name'], $email_data);
		$email_data= str_replace('{user_name}', $this->data['user_details']->username, $email_data);
