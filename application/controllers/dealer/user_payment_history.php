...
class user_payment_history extends Frontend_Controller{	
	public $_redirect = '/dealer/user_payment_history';

	public $_table_names = 'user_history';

	public $_subView = 'ownner/user_payment_history/';
	...
	function index(){
		...
		$this->data['all_data'] = $this->comman_model->get_by($this->_table_names,array('subscribe_status'=>'confirm','user_id'=>$this->data['user_details']->id),false,false,false);	
