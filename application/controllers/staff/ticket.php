...
class Ticket extends Frontend_Controller{
	public $_redirect = '/staff/ticket';

	public $_table_names = 'tickets';

	public $_subView = 'staff/tickets/';
	...
	public function edit($id = NULL){
	    ...
	    if($id){
			...
			$this->data['title'] = $this->data['name'].' | '.$this->data['settings']['site_name'];
            $this->data['tickets'] = $this->comman_model->get_by($this->_table_names,array('id'=>$id,'user_id'=>$this->data['user_details']->parent_id), FALSE, FALSE, true);
...
//			$this->send_mail($id);
	...
	function view($id=false){
		...
		$this->data['title'] = $this->data['name'].' | '.$this->data['settings']['site_name'];
	    if($id){
			$this->data['view_data'] = $this->comman_model->get_by($this->_table_names,array('id'=>$id,'user_id'=>$this->data['user_details']->parent_id), FALSE, FALSE, true);
...
function ajax_get_hour(){	
	...
	function send_mail($id	= false){
		...
		$checkTicket = $this->comman_model->get_by($this->_table_names,array('id'=>$id,'user_id'=>$this->data['user_details']->parent_id),false,false,true);
		if(!$checkTicket)
			return false;
