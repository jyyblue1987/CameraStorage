        ...
        <div data-sortable-id="form-stuff-1" class="panel panel-inverse">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label"><?=show_static_text($lang_id,16);?></label>
                    <div class="col-sm-4">
                        <input type="text"disabled="disabled" class="form-control" value="<?php echo $edit_data->name;?>">
                    </div>
                </div>
                <div class="form-group">                                          
                    <label class="col-sm-2 control-label"><?=show_static_text($lang_id,255);?></label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="form-styles"><?=show_static_text($lang_id,55);?></label>
                    <div class="col-sm-10">
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-2 col-md-9">
	                        <button type="submit" class="btn btn-primary btn-label-left"><?=show_static_text($lang_id,235);?></button>
