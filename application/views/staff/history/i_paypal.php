...
if(count($all_data)){
	...
	foreach($all_data as $set_gym){
		$i++;
		$payment =0;
	$query = "SELECT SUM(amount) as price FROM user_membership_history WHERE ownner_id =".$user_details->id." and payment_type='Paypal' and status ='confirm' and gym_id = $set_gym->id";
