...
<div class="form-body">                    
    ...
    <!--<div class="form-group">
		<label class="col-lg-2 control-label"><?=show_static_text($lang_id,10002);?>Comission ( % )</label>
	    <div class="col-lg-8">
    	    <input class="form-control" type="text" name="comission" value="<?=set_value('comission',$products->comission)?>" required  />
        	<span class="error-span"><?php echo form_error('comission'); ?></span>
		</div>    
    </div>-->
