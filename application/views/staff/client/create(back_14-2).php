...
<div class="form-group" >
	...
	<div class="col-lg-10">
    <input type="checkbox" name="play_w_pay" class="" value="1">
	</div>
</div>
...
<div class="form-group" >
	...
	<div class="col-lg-10">
        ...
        Information in this filed will show up on the top in client's login control panel over Live Camera View section. This is to send any short temporary alert message to that client and this message will remain there until it's removed from this field. Use only if necessary and keep it for short amount of time</span>
