        ...
        <form class="form-horizontal" role="form" method="post">
            ...
            <div class="form-body">
                <div class="form-group">
                    <label class="col-sm-2 control-label"><?=show_static_text($lang_id,51);?></label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label"><?=show_static_text($lang_id,161);?></label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label"><?=show_static_text($lang_id,256);?></label>
                    <div class="col-sm-4">
            ...
            <div class="row">
                <div class="col-md-offset-2 col-md-9">
                    <button type="submit" class="btn btn-primary btn-label-left"><?=show_static_text($lang_id,4);?></button>
