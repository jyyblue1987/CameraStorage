...
<div class="hide-data" style="">
    ...
    <div class="form-group" >
        ...
        <div class="col-sm-10">
            <input class="form-control required-field" name="port" type="text" value="<?=set_value('port', $products->port)?>" placeholder="Port (Ex. RTSP 554)" required />
...
<div class="form-group" >
	<label class="col-lg-2 control-label">Timeszone</label>
	<div class="col-lg-10">
<select name="timeszone" class="form-control " >   
<?php
foreach($timeszone_list as $key=>$val){
?>
<option value="<?=$key?>" <?=$key==$products->timeszone?'selected="selected"':''?>><?=$val?></option>
<?php
}
?>
</select>
<span class="error-span"><?php echo form_error('timeszone'); ?></span>
	</div>
</div>
	<div class="form-group">
