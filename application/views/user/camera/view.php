...
<div class="hide-data" style="">
    ...
    <div class="form-group" >
        ...
        <div class="col-sm-10">
            <input class="form-control required-field" name="port" type="text" value="554" placeholder="Port (Ex. 554)" required />
    ...
    <div class="form-group" >
        ...
        <div class="col-sm-10">
            <input class="form-control required-field" name="password" type="text" value="" autocomplete="off" required />
