...
<div class="form-body">                    
    ...
    <div class="col-md-10">
	    <?=form_input('first_name', set_value('first_name', $user_details->{'first_name'}), 'class="form-control " ')?>
    ...
    <div class="form-group" >
        <label class="col-lg-2 control-label"><?=show_static_text($lang_id,1007);?>Company Name</label>
        <div class="col-md-10">
        <?=form_input('company_name', set_value('company_name', $user_details->{'company_name'}), 'class="form-control " ')?>
    ...
    <div class="form-group" >
	    ...
	    <div class="col-lg-10">
    	    <?=form_input('phone', set_value('phone', $user_details->{'phone'}), 'class="form-control " ')?>
        	<span class="error-span"><?php echo form_error('phone'); ?></span>
        </div>
    </div>

    <div class="form-group" >
        <label class="col-lg-2 control-label"><?=show_static_text($lang_id,8200);?>Mobile Number</label>
	    <div class="col-lg-10">
    	    <?=form_input('phone2', set_value('phone2', $user_details->{'phone2'}), 'class="form-control " ')?>
    ...
    <div class="form-group" >
	    ...
	    <div class="col-lg-10">
    	    <?=form_input('city', set_value('city', $user_details->{'city'}), 'class="form-control " ')?>
    ...
    <div class="form-group" >
	    ...
	    <div class="col-lg-10">
    	    <?=form_input('state', set_value('state', $user_details->{'state'}), 'class="form-control " ')?>
