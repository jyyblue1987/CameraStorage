...
<div id="datepairExample">
	<div class="col-lg-2">
		...
		<input type="text" name="s_time" value="<?=$this->input->get('s_time')?>" class="time start form-control" required/> 
	</div>
	<div class="col-lg-2">
		<label class=" control-label">Time To</label>
		<input type="text" name="e_time" value="<?=$this->input->get('e_time')?>" class="time end form-control" required/> 
...
<tr class="w-list"  data-workout="<?=$filesNameArr[0]?>" style="" >
    ...
    <td><a href="<?=$_cancel.'/download?id='.$view_data->id.'&file='.$set_mp.''?>">Download</a> &nbsp;&nbsp;<a href="<?=$_cancel.'/send_mail?id='.$view_data->id.'&file='.$set_mp.''?>"><?=$video_clipSent>0?'Video clip sent':'Email'?></a> </td>
</tr>
<?php
	}
}
