...
<div class="row">
    <div class="col-md-6">        
        <div class="btn-group">
            <a href="javascript:window.print()" class="btn btn-primary m-r-5 m-b-5">Print <i class="fa fa-print"></i></a>
        </div>
    </div>
                    ...
                    <div class="form-group" >
                        ...
                        <div class="col-lg-10"><?=$order_user_details->first_name.' '.$order_user_details->last_name;?>
                        </div>
                    </div>					 

                    <div class="form-group" >
                        <label class="col-lg-2 control-label" style="padding-top:0px;">Email</label>
                        <div class="col-lg-10"><?=$order_user_details->email;?>
                        </div>
                    </div>					 

                    <div class="form-group" >
                        <label class="col-lg-2 control-label" style="padding-top:0px;">Phone</label>
                        <div class="col-lg-10"><?=$order_user_details->phone;?>
                        </div>
                    </div>

                    <div class="form-group" >
                        <label class="col-lg-2 control-label" style="padding-top:0px;">Address</label>
                        <div class="col-lg-10"><?=$order_user_details->address;?>
                        </div>
                    </div>					 
                    					 
                    <div class="form-group" >
                        <label class="col-lg-2 control-label" style="padding-top:0px;">House Number</label>
                        <div class="col-lg-10"><?=$order_user_details->house_number;?>
                        </div>
                    </div>

                    <div class="form-group" >
                        <label class="col-lg-2 control-label" style="padding-top:0px;">Post code</label>
                        <div class="col-lg-10"><?=$order_user_details->zip;?>
                        </div>
                    </div>

                    <div class="form-group" >
                        <label class="col-lg-2 control-label" style="padding-top:0px;">City</label>
                        <div class="col-lg-10"><?=$order_user_details->city;?>
                        </div>
                    </div>

                    <div class="form-group" >
                        <label class="col-lg-2 control-label" style="padding-top:0px;">Country</label>
                        <div class="col-lg-10"><?=$order_user_details->country;?>
                        </div>
                    </div>
					</div>
...
?>		
                    ...
                    ?>
                                            <tr>
						                        <td><?php echo date('d/m/Y h:i A',strtotime($set_data->date_added));?></td>
