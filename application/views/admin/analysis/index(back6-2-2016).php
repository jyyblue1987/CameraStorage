...
<tr>
    <th>&nbsp;</th>
    <th colspan="<?=(isset($years_data)&&!empty($years_data))?count($years_data):'0'?>">January</th>
    <th colspan="<?=(isset($years_data)&&!empty($years_data))?count($years_data):'0'?>">February</th>
    <th colspan="<?=(isset($years_data)&&!empty($years_data))?count($years_data):'0'?>">March</th>
    <th colspan="<?=(isset($years_data)&&!empty($years_data))?count($years_data):'0'?>">April</th>
    <th colspan="<?=(isset($years_data)&&!empty($years_data))?count($years_data):'0'?>">May</th>
    <th colspan="<?=(isset($years_data)&&!empty($years_data))?count($years_data):'0'?>">June</th>
    <th colspan="<?=(isset($years_data)&&!empty($years_data))?count($years_data):'0'?>">July</th>
    <th colspan="<?=(isset($years_data)&&!empty($years_data))?count($years_data):'0'?>">August</th>
    <th colspan="<?=(isset($years_data)&&!empty($years_data))?count($years_data):'0'?>">September</th>
    <th colspan="<?=(isset($years_data)&&!empty($years_data))?count($years_data):'0'?>">October</th>
    <th colspan="<?=(isset($years_data)&&!empty($years_data))?count($years_data):'0'?>">November</th>
    <th colspan="<?=(isset($years_data)&&!empty($years_data))?count($years_data):'0'?>">December</th>
    <th colspan="<?=(isset($years_data)&&!empty($years_data))?count($years_data):'0'?>">Total</th>
...
<?php
for($i=1;$i<=12;$i++){
	if(isset($years_data)&&!empty($years_data)){
		foreach($years_data as $setY){
			echo '<th>'.$setY->Y.'</th>';
		}
	}
}
