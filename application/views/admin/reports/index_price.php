...
<ul class="nav nav-tabs">
    ...
    <li class=""><a href="<?=$_cancel.'/comparison_engine';?>">Comparison Engine</a></li>
    <li class=""><a href="<?=$_cancel.'?hotel_id='.$this->input->get('hotel_id').'&type=pick2016';?>">Pick2016</a></li>
</ul>	    
...
<thead>
<tr>
    <th colspan="" style="text-align:center">Osservazione</th>
<?php
if($getuploadsdate){
