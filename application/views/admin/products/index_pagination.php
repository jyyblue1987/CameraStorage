    ...
    <div class="row">
	    <div class="col-md-6">
    		<div class="btn-group">
			    ...
			    <a href="<?=$_cancel?>/import" class="btn btn-primary m-r-5 m-b-5">import Csv <i class="fa fa-plus"></i></a>
		    </div>
	    </div>
...
if(count($all_data)){
	foreach($all_data as $set_data){
		...
		if($set_data->store_id!=0){
			...
			if($storeData){
				$storeName = '<a href="'.$_cancel.'/store/'.$set_data->store_id.'">'.$storeData->name.'</a>';
			}
		}
