            ...
            <div class="panel-body">
                ...
                <?=form_open(NULL, array('class' => 'form-horizontal', 'role'=>'form','enctype'=>"multipart/form-data"))?>                                                             
					...
					<div class="form-group" >
                  			<label class="col-lg-2 control-label"><?=show_static_text($adminLangSession['lang_id'],10267);?>Model</label>
                            <div class="col-lg-10">
                               <?=form_input('model', set_value('model', $tags->{'model'}), 'class="form-control " id="" placeholder=""')?>
                            </div>
                        </div>                      
    

					<div class="form-group" >
                  			<label class="col-lg-2 control-label"><?=show_static_text($adminLangSession['lang_id'],2670);?>Weight</label>
                            <div class="col-lg-10">
                               <?=form_input('weight', set_value('weight', $tags->{'weight'}), 'class="form-control " id="" placeholder=""')?>
                            </div>
                        </div>                      
