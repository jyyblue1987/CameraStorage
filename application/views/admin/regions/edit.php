<div class="row">
  ...
  <div class="col-lg-10">
    ...
    <select class="form-control" name="country" id="select_category"  required>
        <option value="" >Select</option>
<?php
if(isset($country_data)&&!empty($country_data)){
foreach($country_data as $setCategory){
?>
<option value="<?=$setCategory->id;?>"  <?=($setCategory->id==$categories->country)?'selected="selected"':'';?> ><?=$setCategory->name;?></option>
<?php
}
}
?>
