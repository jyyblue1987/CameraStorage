...
$p_seller = print_count('users',array('account_type'=>'D'));
$e_admin = print_count('admin',array('default'=>0));
?>
...
<!--        <h4 class="panel-title" style="float:left;margin-right:20px"><i class="fa fa-globe"></i> Chart</h4>-->
        ...
        <!--<div class="row dashboard-box">    
            ...
            <button class="btn bg-purple  m-r-5 m-b-5" type="button">Company <?php //count($users)?></button>
            <button class="btn bg-green  m-r-5 m-b-5" type="button">Customer <?php ///count($users2)?></button>
            <button class="btn m-r-5 m-b-5" style="background:#EAA228" type="button">Ticket On Time <?php //count($OntimeTicket)?></button>
            <button class="btn m-r-5 m-b-5" style="background:#953579" type="button">Ticket On Delay <?php //count($DelayTicket)?></button>    
	    </div>-->
