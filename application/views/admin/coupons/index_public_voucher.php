...
?>
                        ...
                        <td><?php echo date('d/m/Y',strtotime($set_data->end_date));?></td>
							
							<td>
<!--                            <a class="btn btn-icon-only btn-info" href="admin/coupon/user_mail/<?php echo $set_data->id;?>" >
										<i class="fa fa-mail-forward"></i></a>-->
                            <a class="btn btn-icon-only btn-success " href="admin/coupon/edit/<?php echo $set_data->id;?>" >
										<i class="fa fa-edit"></i></a>
                            	<a class="btn btn-icon-only btn-danger" href="admin/coupon/delete/<?php echo $set_data->id;?>"  onclick="return confirm_box();" >
