...
<tr>
    ...
    <td><?=print_value('memberships',array('id'=>$set_data->plan_id),'price2');?></td>
...
<?=$set_data->is_set==1?'<i class="fa fa-check"></i>':'';?>
                        ...
                        <td>
<a class="btn btn-icon-only btn-info " href="<?=$_cancel.'/edit/'.$set_data->id;?>" data-toggle="tooltip" data-placement="top"  title="Edit" ><i class="fa fa-edit"></i></a>
