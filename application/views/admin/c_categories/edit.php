            ...
            <div class="panel-body">
                ...
                <?=form_open(NULL, array('class' => 'form-horizontal', 'role'=>'form','enctype'=>"multipart/form-data"))?>                                                             
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <?php echo form_dropdown('type', $type_data, $this->input->post('type') ? $this->input->post('type') : $categories->type, 'class="form-control"'); ?>
                            </div>
                        </div>
	                        <!--<div class="form-group">
				      	...
				      	<div class="fileinput fileinput-new" data-provides="fileinput">
                           ...
                           <div style="margin-bottom: 0px;" class="tabbable">
                              ...
                              //  foreach($this->page_m->languages as $key_lang=>$val_lang):
                                foreach($this->c_category_model->languages_icon as $key_lang=>$val_lang):
                              ...
                              <div style="padding-top: 9px; border-bottom: 1px solid #ddd;" class="tab-content">
                                <?php $i=0;foreach($this->c_category_model->languages as $key_lang=>$val_lang):$i++;?>
