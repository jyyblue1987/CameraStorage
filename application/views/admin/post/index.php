...
?>
    <tr>
        ...
        <td><img src="<?=$image?>" class="img-rounded" style="width:30px;height:30px"> 

<?php
if(!empty($set_data->share_image_1)){
	$titleColor ='#0C0';
}
else{
	$titleColor ='#000';
...
?>
	<span style="color:<?=$titleColor?>"><?=$set_data->title;?></span>
        </td>
        <td><?=$categoryName;?></td>
        <td>
<?php
$html = strip_tags($set_data->body);
