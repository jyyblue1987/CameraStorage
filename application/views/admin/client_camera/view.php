	...
	<div class="col-md-12">
        ...
        <div data-sortable-id="form-stuff-1" class="panel panel-inverse">
            ...
            <div class="btn-group black-btn">
                <a href="<?=$_cancel.'/c_v/'.$view_data->user_id?>" class="btn btn-primary m-r-5 m-b-5">Back</a>
            </div>
<div class="portlet-body">
    <div class="row static-info">
        <div class="col-md-3 name"><b>Client</b></div>
    ...
    <div class="row static-info">
        ...
        <div class="col-md-9 value"><?=$view_data->model;?></div>
    </div>
<?php
