<div class="row">
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        ...
        <select class="form-control" name="region_id" id="select_category"  required>
            <option value="" >Select</option>
    <?php
    if(isset($country_data)&&!empty($country_data)){
    foreach($country_data as $setCategory){
    ?>
    <option value="<?=$setCategory->id;?>"  <?=($setCategory->id==$categories->region_id)?'selected="selected"':'';?> ><?=$setCategory->name;?></option>
    <?php
    }
    }
    ?>
