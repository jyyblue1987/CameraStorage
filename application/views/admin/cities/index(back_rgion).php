    ...
    <div class="table-responsive">
        <table id="data-table" class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <th><?=show_static_text($adminLangSession['lang_id'],5500);?>State</th>
...
if(count($all_data)){
	foreach($all_data as $set_data){
		$tagName ='-';
		if($set_data->region_id!=0){
			$storeData = $this->comman_model->get_by('regions',array('id'=>$set_data->region_id),false,false,true);
			if($storeData){
