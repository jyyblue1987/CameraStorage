                      ...
                      <div class="col-lg-10">
				      	<div class="fileinput fileinput-new" data-provides="fileinput">
							<div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
                                <?php echo !isset($categories->image) ? '<img src="assets/uploads/no-image.gif">' :'<img src="'.base_url('assets/uploads/cities/thumbnails').'/'.$categories->image.'" >'; ?>
                            </div>
							<div>
		                    ...
		                    <div class="form-group">
                              ...
                              <div class="col-lg-10">
                                <?=form_textarea('desc', html_entity_decode(set_value('desc', $categories->{'desc'})), 'placeholder="" rows="3" class="cleditor2 form-control"')?>
                              </div>
                            </div>
