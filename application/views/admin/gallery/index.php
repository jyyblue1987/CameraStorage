...
<table id="data-table" class="table table-striped table-bordered">
    ...
    <tr>
        ...
        <th><?=show_static_text($adminLangSession['lang_id'],263);?></th>
...
?>
            <tr>
                <td><?=$set_data->id;?></td>
                <td><img src="<?= !empty($set_data->image)?'assets/uploads/gallery/thumbnails/'.$set_data->image:'assets/uploads/no-image.gif';?>" class="img-rounded" style="width:30px;height:30px"></td>
