    ...
    <div class="table-responsive">
        <table id="data-table" class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <th><?=show_static_text($adminLangSession['lang_id'],1800);?>Ownner</th>
<!--                <th><?=show_static_text($adminLangSession['lang_id'],1800);?>Options</th>-->
            </tr>
            </thead>
            <tbody>
...
if(count($all_data)){
	foreach($all_data as $set_data){
		...
		if($set_data->parent_id!=0){
			...
			if($company_data){
				$companyName = $company_data->username;
			}
		}
...
?>
                    <tr>
                        ...
                        <!--<td>
<?php
if($set_data->account_type=='A'){
?>
<a class="btn btn-icon-only btn-info " href="<?=$admin_link.'/performance/l/'.$set_data->id;?>" >Performance</a>
