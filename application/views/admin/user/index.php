...
<a class="btn btn-icon-only btn-info " href="<?=$_cancel.'/edit/'.$set_data->id;?>" data-toggle="tooltip" data-placement="top"  title="Flash Notice" ><i class="fa fa-edit"></i></a>
...
<!--<a class="btn btn-icon-only btn-info " href="<?=$_cancel.'/edit/'.$set_data->id;?>" title="" ><i class="fa fa-edit"></i></a>-->
