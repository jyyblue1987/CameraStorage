                      ...
                      <div class="col-lg-10">
				      	<div class="fileinput fileinput-new" data-provides="fileinput">
							<div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
                                <?php echo !isset($categories->image) ? '<img src="assets/uploads/no-image.gif">' :'<img src="'.base_url('assets/uploads/departments/thumbnails').'/'.$categories->image.'" >'; ?>
                            </div>
							<div>
                           ...
                           <div style="margin-bottom: 0px;" class="tabbable">
                              ...
                              //  foreach($this->page_m->languages as $key_lang=>$val_lang):
                                foreach($this->department_model->languages_icon as $key_lang=>$val_lang):
                              ...
                              <div style="padding-top: 9px; border-bottom: 1px solid #ddd;" class="tab-content">
                                <?php $i=0;foreach($this->department_model->languages as $key_lang=>$val_lang):$i++;?>
                              ...
                              <div class="col-lg-10">
                                <?=form_textarea('body_'.$key_lang, set_value('body_'.$key_lang, $categories->{'body_'.$key_lang}), 'placeholder="Body" rows="3" class="cleditor2 form-control"')?>
                              </div>
                            </div>
                                </div>
                                <?php endforeach;?>
